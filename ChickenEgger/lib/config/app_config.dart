...
class AppConfig {
  ...
  static const double eggDropInterval = 0.1; // seconds between egg drops (faster!)
  static const int maxEggsOnScreen = 10; // more eggs allowed
  ...
  // Ad settings
  static const int gamesBeforeInterstitial = 3;
  static const int rewardedAdBonusPoints = 50;
  ...
  static String get bannerAdUnitId {
    ...
    // Return empty string for unsupported platforms (desktop)
    return '';
  }
